...
{      
	...
	SysMsg.AdjVol.R_VNN1 = (uint32_t)(((((3.3 - (Adc_ReadConvertValue(SAMPLE_VNN1_SEQUENCE) * 3.3 / 4095)) / 2.67) * (2.67 + 100)) - 3.3) * 100);
	SysMsg.AdjVol.R_VPP2 = (uint32_t)(((Adc_ReadConvertValue(SAMPLE_VPP2_SEQUENCE) * 3.3 / 4095) / 4.22 * (100 + 4.22)) * 100);
	SysMsg.AdjVol.R_VNN2 = (uint32_t)(((((3.3 - (Adc_ReadConvertValue(SAMPLE_VNN2_SEQUENCE) * 3.3 / 4095)) / 2.67) * (2.67 + 100)) - 3.3) * 100);
    ...
    SysMsg.AdjVol.R_AN5V5 = (uint32_t)(((((3.3 - (Adc_ReadConvertValue(SAMPLE_AN5V5_SEQUENCE) * 3.3 / 4095)) / 4.99) * (4.99 + 110)) - 3.3) * 100);
